...
class GradeEvaluationHistoryExport implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles, WithTitle
{
    ...
    {
        $gradeIds = Grade::where('evaluation_id', $this->evaluationId)->pluck('id');
