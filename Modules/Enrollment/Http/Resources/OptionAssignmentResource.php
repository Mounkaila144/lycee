...
class OptionAssignmentResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'choice_rank_obtained' => $this->choice_rank_obtained,
            'choice_rank_obtained_label' => $this->getChoiceRankObtainedLabel(),
            'assignment_method' => $this->assignment_method,
            'assignment_method_label' => $this->getAssignmentMethodLabel(),
